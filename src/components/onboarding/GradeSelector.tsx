...
import { features, setFeatureFlag } from "../../config/featureFlags";
...
export const GradeSelector: React.FC<GradeSelectorProps> = ({ onSubmit }) => {
    ...
    const handleGradeChange = (val: number) => {
        ...
        // Toggle feature flag based on selection for immediate UI feedback capability
        const isSprout = val === GradeBands.SPROUTS;
        setFeatureFlag('simplifiedUi', isSprout);
    };
    ...
    const handleSubmit = (e?: React.FormEvent) => {
        ...
        // Log the decision
        TelemetryService.logEvent("session.start", {
            grade_band: selectedGrade,
            simplified_ui: selectedGrade === GradeBands.SPROUTS
        });
